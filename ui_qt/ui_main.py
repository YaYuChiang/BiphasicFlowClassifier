...
# Form implementation generated from reading ui file 'd:\ws\BiphasicFlowClassifier\ui_qt\main.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(743, 648)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.groupBox_4 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_4.setGeometry(QtCore.QRect(10, 110, 721, 491))
        self.groupBox_4.setObjectName("groupBox_4")
        self.pushButton = QtWidgets.QPushButton(self.groupBox_4)
        self.pushButton.setGeometry(QtCore.QRect(560, 290, 151, 31))
        self.pushButton.setObjectName("pushButton")
        self.label_4 = QtWidgets.QLabel(self.groupBox_4)
        self.label_4.setGeometry(QtCore.QRect(10, 20, 111, 20))
        ...
        self.groupBox.setGeometry(QtCore.QRect(10, 140, 701, 71))
        ...
        self.label_10.setGeometry(QtCore.QRect(410, 20, 121, 16))
        ...
        self.comboBox_experiment.setGeometry(QtCore.QRect(380, 20, 331, 20))
        self.comboBox_experiment.setObjectName("comboBox_experiment")
        self.label = QtWidgets.QLabel(self.groupBox_4)
        self.label.setGeometry(QtCore.QRect(290, 20, 81, 16))
        self.label.setObjectName("label")
        self.groupBox_2 = QtWidgets.QGroupBox(self.groupBox_4)
        self.groupBox_2.setGeometry(QtCore.QRect(10, 210, 701, 71))
        self.groupBox_2.setObjectName("groupBox_2")
        self.layoutWidget = QtWidgets.QWidget(self.groupBox_2)
        self.layoutWidget.setGeometry(QtCore.QRect(10, 20, 681, 41))
        ...
        self.comboBox_type_liquid.setGeometry(QtCore.QRect(120, 20, 121, 20))
        ...
        self.textEdit_res.setGeometry(QtCore.QRect(0, 330, 711, 151))
        self.textEdit_res.setObjectName("textEdit_res")
        self.groupBox_3 = QtWidgets.QGroupBox(self.groupBox_4)
        self.groupBox_3.setGeometry(QtCore.QRect(10, 50, 701, 91))
        self.groupBox_3.setObjectName("groupBox_3")
        self.layoutWidget1 = QtWidgets.QWidget(self.groupBox_3)
        self.layoutWidget1.setGeometry(QtCore.QRect(10, 20, 681, 61))
        ...
        self.groupBox_5.setGeometry(QtCore.QRect(10, 0, 721, 111))
        ...
        self.comboBox_experiment_2.setGeometry(QtCore.QRect(130, 20, 431, 21))
        ...
        self.pushButton_training.setGeometry(QtCore.QRect(620, 80, 91, 31))
        ...
        self.pushButton_setTestPath = QtWidgets.QPushButton(self.groupBox_5)
        self.pushButton_setTestPath.setGeometry(QtCore.QRect(540, 80, 75, 27))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.lineEdit_testPath = QtWidgets.QLineEdit(self.groupBox_5)
        self.lineEdit_testPath.setGeometry(QtCore.QRect(100, 80, 441, 25))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_12.setGeometry(QtCore.QRect(9, 80, 81, 29))
        self.label_12.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_12.setObjectName("label_12")
        self.label_11 = QtWidgets.QLabel(self.groupBox_5)
        self.label_11.setGeometry(QtCore.QRect(10, 50, 81, 29))
        self.label_11.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_11.setObjectName("label_11")
        self.lineEdit_trainPath = QtWidgets.QLineEdit(self.groupBox_5)
        self.lineEdit_trainPath.setGeometry(QtCore.QRect(100, 50, 441, 25))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pushButton_setTrainPath = QtWidgets.QPushButton(self.groupBox_5)
        self.pushButton_setTrainPath.setGeometry(QtCore.QRect(540, 50, 75, 27))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_setTestPath.setText(_translate("MainWindow", "find"))
        self.label_12.setText(_translate("MainWindow", "Test data"))
        self.label_11.setText(_translate("MainWindow", "Train data"))
        self.pushButton_setTrainPath.setText(_translate("MainWindow", "find"))
